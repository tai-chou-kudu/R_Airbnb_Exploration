...
A: Each row represents an Airbnb listing. Each column represents and aspect of the listing, such as number of bedrooms, neighborhood location, price of rental, or listing url.
...
neighborhoods_of_interest <- c("Bedford-Stuyvesant", "East New York", "Crown Heights", "Flatbush", "Sunset Park")
...
```{r}
ggplot(filtered_data, aes(x = neighborhood, y = review_scores_rating, fill = neighborhood)) +
  geom_boxplot() +
